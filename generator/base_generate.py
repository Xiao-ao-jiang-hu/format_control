...
#model = BaseModel.from_pretrained("result/base/checkpoint30000", pad_token_id=sep_token,  eos_token_id=eos_token).to(device).eval()
model = BaseModel.from_pretrained("result/base/checkpoint120000")
...
print(tokenizer.tokenize("今天开始我要自己上厕所，爸爸妈妈你们不要小看我。"))